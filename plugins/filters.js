...
const array = ['Amalser','chaya','escape','truth','hm','pottan','oh','alive','nokk','nude','oo','kali','Remove''bot','lost','copy','Da','come','sex','help','sorry','not','podi','nee','done','kalam','Di','Dey']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
