...
const array = ['Amalser','chaya','escape','truth','nice','let','get','img','list','hm','pottan','oh','alive','nokk','nude','oo','kali','Remove''bot','lost','copy','Da','come','sex','sed','help','sorry','not','podi','nee','done','oru','kalam','Di','Dey']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
