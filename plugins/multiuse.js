...
Asena.addCommand({ pattern: 'insta ?(.*)', fromMe: false, desc: IG_DESC }, async (message, match) => {
    ...
    let { data, type } = await instaGram(match[1], 'odsMYXx67ZhT38w5hp5mgRKO8En');
    //if(type == undefined) return await message.sendMessage(infoMessage(Lang.LOADING))
